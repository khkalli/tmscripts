...
// @author       khkalli
// @match        https://ci.designskins.com/login*
...
(function() {
    ...
    async function getCredentials() {
        let username = localStorage.getItem('designskinsLoginUsername');
        let password = localStorage.getItem('designskinsLoginPassword');

        if (!username || !password) {
            const credentials = await createLoginModal();
            if (credentials.username && credentials.password) {
                localStorage.setItem('designskinsLoginUsername', credentials.username);
                localStorage.setItem('designskinsLoginPassword', credentials.password);
            }
            return credentials;
        }
    ...
    window.addEventListener('load', async function() {
        let usernameField = document.getElementById('j_username');
        let passwordField = document.getElementById('j_password');
