// ==UserScript==
// @name         Secure Auto-Login for JIRA
...
(function() {
    ...
    // Möglichkeit, gespeicherte Daten zurückzusetzen
    GM_registerMenuCommand("Jira Login-Daten zurücksetzen", function() {
        localStorage.removeItem('jiraLoginUsername');
        localStorage.removeItem('jiraLoginPassword');
        alert('Jira Login-Daten wurden zurückgesetzt.');
    });
})();
